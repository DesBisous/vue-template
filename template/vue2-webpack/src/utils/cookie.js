/**
 * @method getDomain 获取 cookie 所需的 domain
 */
 ...
 * @return {Undefined}
 */
export function setCookie(name, value, time, domain = getDomain(), path = '/') {
 ...
 */
export function deleteCookie(name, domain = getDomain(), path = '/') {
